...
from services import llm_provider, sarvam_service
...
async def rag_query(query: RAGQuery):
    ...
    # Query LLM via provider
    result = await llm_provider.rag_query(patient_history, query.question, patient_memory=memory)
